...
현재 단계: **v2.3.0 진행 중** (레시피 상자 목업 기능 확장 · G2 디자인/API 계약 단계) — 브랜치 `v2.3.0`
...
- [ ] **사용자 재베이스라인**: `./harness/baseline.sh --approve v2.3.0` (사용자만 실행) ← 다음 단계
- [ ] G4 배포 (CI·릴리스노트·screen-guide 갱신)
